...
Paraphrase Multilingual MPNet is a text embedding model developed by **Sentence Transformers** in 2021. It was trained using knowledge distillation from MPNet to support more than `50` languages. 
